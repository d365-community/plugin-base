...
namespace D365.Community.Model
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<D365.Community.Model.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<D365.Community.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<D365.Community.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<D365.Community.Model.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<D365.Community.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<D365.Community.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public D365.Community.Model.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<D365.Community.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<D365.Community.Model.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public D365.Community.Model.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<D365.Community.Model.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
